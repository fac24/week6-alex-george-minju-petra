...
INSERT INTO products (name, category_id, stock, price, description, photo_url, variants, colours, brand_id) VALUES
  ...
  ('Logitech MX Master 3', 4, 1, 55.12, 'Ergonomic mouse with a maximum DPI of 4000 with a whopping 7 buttons! Oh and it is laser tracked.', 'https://i.ebayimg.com/images/g/FwoAAOSw9UFiqGCE/s-l500.jpg', '{variants: ["wireless", "wired"]}', '{colours: ["grey"]}',3),
  ('MacBook Pro 13.3-inch 2020', 2, 2, 1269.00, 'Apple M1 Chip with 8‑Core CPU and 8‑Core GPU', 'https://store.storeimages.cdn-apple.com/4668/as-images.apple.com/is/mbp-spacegray-select-202206_GEO_GB?wid=904&hei=840&fmt=jpeg&qlt=90&.v=1654014010023', '{variants: ["256GB SSD Storage", "512GB SSD Storage"]}', '{colours: ["silver", "space grey"]}', 2),
